...
INSERT INTO 학생2
VALUES('s003','이순신',DEFAULT,4,53,'남',NULL,NULL);
...
ALTER DATABASE univdb OWNER TO manager; -- postgres 계정만 실행할수 있다.
...
--인덱스
CREATE INDEX idx_수강 ON 수강(학번, 과목번호); --오류: 소유자만 가능 있다면, postgres계정에서 실행
